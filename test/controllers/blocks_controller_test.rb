...
class BlocksControllerTest < ActionController::TestCase
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post :create, block: { end_number: @block.end_number, number: @block.number, start_number: @block.start_number }
    end
  ...
  test "should update block" do
    patch :update, id: @block, block: { end_number: @block.end_number, number: @block.number, start_number: @block.start_number }
    assert_redirected_to block_path(assigns(:block))
  end
